...
def main() -> None:
    ...
    max_samples_per_class = args.classes
    ...
    asr = 0
    if args.benign:
        folder_path = f'data/{gen}/{args.run_nr}/{args.dataset}/{args.model}/{args.att}/images_{args.eps}/ben_{args.classes}/'
        ...
        for i, (image, label) in enumerate(image_loader(), 1):
            if class_labels[label] in random_classes:
                ...
                if class_counts[class_labels[label]] <= max_samples_per_class:
                    ...
                    image_pil.save(f'data/{gen}/{args.run_nr}/{args.dataset}/{args.model}/{args.att}/images_{args.eps}/ben_{args.classes}/{counter}.png')
    ...
    if args.attack:
        folder_path = f'data/{gen}/{args.run_nr}/{args.dataset}/{args.model}/{args.att}/images_{args.eps}/att_{args.classes}/'
                ...
                if class_counts[class_labels[label]] < max_samples_per_class:
                    ...
                    if y_pred == label:
                        ...
                        if success.cpu().item():
                            ...
                            image_pil_adv.save(f'data/{gen}/{args.run_nr}/{args.dataset}/{args.model}/{args.att}/images_{args.eps}/att_{args.classes}/{counter}.png')
    ...
    log['elapsed_time'] = str(hours) + "h:" + str(minues) + "m"
