...
def train_loader(args, dataset_id="pcuenq/lsun-bedrooms", split='train', image_size=256):
    from cfg import huggingface_cache_path

    dataset = load_dataset(dataset_id, split=split, cache_dir=huggingface_cache_path)
