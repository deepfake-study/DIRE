...
def main() -> None:
    ...
    parser.add_argument("--classes",   default=1, help="")
    parser.add_argument("--max_samples_per_class",   default=10000, help="")
    ...
    if args.benign:
        ...
        iterations = 1
        images = []
        for it, img in tqdm(enumerate(train_dataloader), total=10000):
            tmp_img = img["images"]
    ...
    if args.attack:
        folder_path = f'data/adversarial/gen/{args.run_nr}/{args.dataset}/{args.model}/{args.att}/images_{args.eps}/att_{args.classes}/'
